  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group bg-background fixed z-50 flex flex-col",
        ...
        {...props}
      >
        <div className="bg-muted mx-auto mt-4 hidden h-2 w-[100px] rounded-full data-[vaul-drawer-direction=bottom]:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
